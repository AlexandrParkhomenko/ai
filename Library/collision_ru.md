...
Введение
    1.1 Обзор содержания
        1.1.2 Глава 2: Проблемы проектирования обнаружения столкновений
        1.1.2 Глава 3: Учебник по математике и геометрии
        1.1.3 Глава 4: Ограничивающие объёмы
        1.1.4 Глава 5: Базовые примитивные тесты
...
Ограничивающие объёмы
    ...
    4.2 Выровненные по оси ограничительные параллелипипеды (Axis-aligned Bounding Boxes, AABBs)
        ...
        4.2.2 Вычисления и обновления AABBs
    ...
    4.5 Объемы, охваченные сферой
        4.5.1 Пересечение объемов, охваченных сферой
        4.5.2 Вычисление ограничивающих объемов, охватываемых сферой
    4.6 Объемы пересечения полупространства
        ...
        4.6.3 Тест на перекрытие k-DOP – k-DOP
...
Геометрическая устойчивость
    ...
    12.5 Триангуляция и выпуклое разбиение
        12.5.1 Триангуляция путем разрезания ушей [1](https://ru.wikipedia.org/wiki/Задача_о_триангуляции_многоугольника#Отрезание_ушей)
